  ...
  cardDef: __table(
    {
      ...
      indexes: [
        {
          accessor: "defId",
          name: "card_def_def_id_idx_btree",
          algorithm: "btree",
          columns: ["defId"],
        },
      ],
  ...
  slotDef: __table(
    {
      ...
      indexes: [
        {
          accessor: "defId",
          name: "slot_def_def_id_idx_btree",
          algorithm: "btree",
          columns: ["defId"],
        },
        {
          accessor: "id",
          name: "slot_def_id_idx_btree",
          algorithm: "btree",
          columns: ["id"],
        },
      ],
      constraints: [
        { name: "slot_def_id_key", constraint: "unique", columns: ["id"] },
      ],
    },
    SlotDefRow,
  ),
